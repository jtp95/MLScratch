...
class DecisionTree():
    def __init__(self, task="classification", criterion="gini", max_depth=5, min_sample=2):
        self.task = task
    ...
    def _create_node(self, X, y, depth=0):
        if depth > self.max_depth or len(y) < self.min_sample:
